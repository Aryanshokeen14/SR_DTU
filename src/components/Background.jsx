  ...
  useGSAP(() => {
    ...
    return (
      <>
        ...
        <div className="bg-[url('/assets/video1.mp4')] bg-cover bg-center h-screen flex justify-center items-center flex-col gap-4">
        ...
        <div className="bg-slate-100 h-[1000px] flex items-center flex-col py-12">
          ...
          <div className="cards flex gap-24 ">
            <div className="h-[500px] w-[300px] border border-black rounded-xl bg-black text-white">
              <img src="/assets/image6.jpeg" alt="image6" className="h-[250px] w-[300px] rounded-t-xl"/>
            ...
            <div className="h-[500px] w-[300px] border border-black rounded-xl bg-black text-white">
              <img src="/assets/image7.jpeg" alt="image6" className="h-[250px] w-[300px] rounded-t-xl"/>
              <div className="flex flex-col justify-center items-center h-1/2 w-[300px] p-7 gap-6">
            ...
            <div className="h-[500px] w-[300px] border border-black rounded-xl bg-black text-white">
              <img src="/assets/image8.jpeg" alt="image6" className="h-[250px] w-[300px] rounded-t-xl"/>
              <div className="flex flex-col justify-center items-center h-1/2 w-[300px] p-7 gap-6">
